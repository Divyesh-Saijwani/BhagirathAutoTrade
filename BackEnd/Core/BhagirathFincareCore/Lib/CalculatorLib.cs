...
{
    public partial class CalculatorLib
    {
        public object calculator(Calculator calculatormv)
        {
            ...
            try
            {
                ...
                int buycount = 0;
                int salcount = 0;
                //  Model.Clear(); // this is very important line for moving data back to the view 

                //calculatormv.txt_m3 = Convert.ToString(234); // testing on 1/june/2016
                //calculatormv.TextBox1 = Convert.ToString(999);
                //return View(calculatormv); 


                // clearing variables for reverse call
                calculatormv.txt_reversecall = "";
                calculatormv.Txt_salesl = "";
                calculatormv.Txt_salet1 = "";
                calculatormv.Txt_salet2 = "";
                calculatormv.Txt_salet3 = "";

                calculatormv.txt_Buysl = "";
                calculatormv.txt_buyt1 = "";
                calculatormv.txt_buyt2 = "";
                calculatormv.Txt_buyt3 = "";


                m3 = Convert.ToDouble(calculatormv.txt_m3); //3188; //Average
                m4 = Convert.ToDouble(calculatormv.txt_m4);  //open
                m5 = Convert.ToDouble(calculatormv.txt_m5);  //c
                l8 = Convert.ToDouble(calculatormv.txt_l8);  //cmp
                d8 = Convert.ToDouble(calculatormv.txt_d8);  //tdl
                t8 = Convert.ToDouble(calculatormv.txt_t8);  //tdh
                t10 = Convert.ToDouble(calculatormv.txt_t10); //idh
                d10 = Convert.ToDouble(calculatormv.txt_d10); //idl
                t11 = Convert.ToDouble(calculatormv.txt_t11); //pdh
                d11 = Convert.ToDouble(calculatormv.txt_d11);//pdl
                q16 = Convert.ToDouble(calculatormv.txt_q16);//CTHD
                f19 = Convert.ToDouble(calculatormv.txt_f19);//ctld
            ...
            Recalculate:
                ...
                //txt_K13.Text = txt_K13.Text + " =calculated " + trandview;
                k13 = trandview;
                calculatormv.txt_K13 = trandview;
                // added this on 12/may/2015 for not displaying trandeview in case of special case
                if (!specialcase)
                {
                    calculatormv.txt_K13_not = trandview;
                }
                else
                {
                    calculatormv.txt_K13_not = "";
                }
                ...
                calculatormv.txt_k8 = Convert.ToString(k8);
                calculatormv.txt_m8 = Convert.ToString(m8);
                ...
                if (l10 == r16)  // if ct = CTHD
                {
                    ...
                    calculatormv.txt_K9 = arrws[(myIndex - 1)].ToString();  // calculated ws
                                                                            //txt_K9.Text = arrws[(myIndex)].ToString();  // calculated ws  changed on 15april2015
                    k9 = arrws[(myIndex - 1)];
                    ...
                    //txt_M9.Text = arrws[(myIndex-1)].ToString(); // calculted wr
                    ...
                    {
                        calculatormv.txt_M9 = q16.ToString(); // cthd as on 1/may/2015
                        m9 = q16;
                    }
                    else
                    {
                        calculatormv.txt_M9 = arrws[(myIndex)].ToString();  // changed here on 15/april/2015
                        m9 = arrws[myIndex];
                    }
                    //m9 = arrws[myIndex-1];
                    //m9 = arrws[myIndex];
                ...
                if (l10 == e19) // if ct = CTLD
                {
                    ...
                    calculatormv.txt_K9 = arrwr[(myIndex - 1)].ToString();  // calculated ws
                    k9 = arrwr[(myIndex - 1)];
                    // wr level  should be above bnr level from tempws above cthd
                    // bnr = m8
                    myObject = m8; //bnr
                    ...
                    calculatormv.txt_M9 = arrwr[myIndex].ToString(); // calculted wr
                    m9 = arrwr[myIndex];
                ...
                calculatormv.txt_D6 = Convert.ToString(d6);
                calculatormv.txt_E6 = Convert.ToString(e6);
                calculatormv.txt_F6 = Convert.ToString(f6);
                calculatormv.txt_G6 = Convert.ToString(g6);
                calculatormv.txt_H6 = Convert.ToString(h6);
                calculatormv.txt_I6 = Convert.ToString(i6);
                calculatormv.txt_J6 = Convert.ToString(j6);
                calculatormv.txt_K6 = Convert.ToString(k6);
                calculatormv.txt_N6 = Convert.ToString(n6);
                calculatormv.txt_O6 = Convert.ToString(o6);
                calculatormv.txt_P6 = Convert.ToString(p6);
                calculatormv.txt_Q6 = Convert.ToString(q6);
                calculatormv.txt_R6 = Convert.ToString(r6);
                calculatormv.txt_S6 = Convert.ToString(s6);
                calculatormv.txt_T6 = Convert.ToString(t6);
                calculatormv.txt_U6 = Convert.ToString(u6);
                // txt_H12.Text ="";
                //txt_K13.Text = k13; commented here on 24/april/2015 to display trandview from calculation
                calculatormv.txt_J13 = Convert.ToString(j13);
                calculatormv.txt_N13 = Convert.ToString(n13);
                calculatormv.txt_M6 = Convert.ToString(m6);
                ...
                // TextBox3.Text = j23.ToString(); // this value is assigned in row25 calculation
                #endregion
                ...
                if (i25 < 0 || i25 >= 100 || j25 < 0 || j25 >= 100)  // after discussion with sunilbhai if any value is below 0 or greate than 100 will hit stoploss
                {
                    ...
                    // TextBox1.Text = i25.ToString() + " ( STOPLOSS HIT )"; 
                    calculatormv.TextBox1 = "";  // negative value 
                    calculatormv.TextBox2 = "";  // positive value
                    calculatormv.TextBox3 = "";  // range value
                                                 // uint myUint = (uint)Math.Round(50.11, 0);

                    // need to check this on 1/june/2016
                    // ViewBag["width"] = 500;
                    //Label15.Width = new Unit((Math.Round(Math.Abs(50.01), 0)) * 2);
                    //Label16.Width = new Unit((Math.Round(Math.Abs(50.01), 0)) * 2); 
                    // checking of 1/june/2016 ends here

                }
                else
                {
                    calculatormv.TextBox1 = i25.ToString();  // negative value
                    calculatormv.TextBox2 = j25.ToString(); // positive value
                    calculatormv.TextBox3 = j23.ToString();  // range value
                                                             //  uint mynt = (uint)Math.Round(i25, 0);
                ...
                calculatormv.txt_I12 = i12.ToString();  // buy sl
                calculatormv.txt_O12 = o12.ToString();   // sell sl
                ...
                if (((100 * buycount) / 3) >= 100)
                {
                        ...
                        if (m3 != m6 && !(goforrecaculation))
                        {
                            ...
                            while (i > 0)
                            {
                                ...
                                if (tempm3 <= tempm6)
                                {
                                    ...
                                    m3 = tempm3;
                                    // goto outprint1;
                                    calculatormv.txt_m3 = m3.ToString(); // changed on 20/may/2015
                    ...
                    outprint1:
                        ...
                        if (d10 > k6)
                        {
                            calculatormv.txt_reversecall = "BUY";
                            double intrimk6value = 0;
                            intrimk6value = (0.00013 * k6);
                            k6 = k6 + intrimk6value;
                            k6 = Math.Round(k6, 2);
                            calculatormv.txt_Buysl = Convert.ToString(k6);
                            calculatormv.txt_buyt1 = Convert.ToString(o6);
                            calculatormv.txt_buyt2 = Convert.ToString(p6);
                            calculatormv.Txt_buyt3 = Convert.ToString(q6);
                            calculatormv.txt_reverseBAP = Convert.ToString(m3); // as per output excel it is average or m6 value
                                                                                // check this on 1/june/2016 calculatormv.txt_possibilities.Text = Convert.ToString(((100 * buycount) / 3));
                ...
                if (((100 * salcount) / 3) >= 100)
                {
                        ...
                        if (m3 != m6 && !(goforrecaculation))
                        {
                            ...
                            for (double i = m3; i <= m3 + 200; i++)
                            {
                                ...
                                if (tempm3 >= tempm6)
                                {
                                    ...
                                    testmv = tempm6;
                                    m3 = tempm3;
                                    calculatormv.txt_m3 = m3.ToString(); // added on 20/may/2015
                                    goforrecaculation = true;
                                    //  goto outprint;
                                    goto Recalculate; // label define at the top for recalculating 
                                }
                    ...
                    outprint:
                        calculatormv.txt_reversecall = "SELL";
                        // according to sunilbhai add the value of 0.00013 of n6 to the n6 value 
                        double intrimn6value = 0;
                        intrimn6value = (0.00013 * n6);
                        n6 = n6 + intrimn6value;
                        n6 = Math.Round(n6, 2);
                        calculatormv.Txt_salesl = Convert.ToString(n6);
                        calculatormv.Txt_salet1 = Convert.ToString(j6);
                        calculatormv.Txt_salet2 = Convert.ToString(i6);
                        calculatormv.Txt_salet3 = Convert.ToString(h6);
                        calculatormv.txt_reverseBAP = Convert.ToString(m3);  // as per output excel it is average or m6 value
                                                                             // need to check this on 1/june/2016calculatormv.txt_possibilities.Text = Convert.ToString(((100 * salcount) / 3));
                                                                             // here we need to change the value of s-bap and r-bap if reverse call is there and 
                ...
                if (!specialcase)
                {
                    ...
                    {
                        calculatormv.txt_tcreversecall = "BUY";
                        // txt_tcBuysl.Text = Convert.ToString(k6); // commented as per sunilbhai on 4/may/2015
                        calculatormv.txt_tcBuysl = Convert.ToString(i12);
                        calculatormv.txt_tcbuyt1 = Convert.ToString(o6);
                        calculatormv.txt_tcbuyt2 = Convert.ToString(p6);
                        calculatormv.txt_tcbuyt3 = Convert.ToString(q6);

                        // txt_tcpossibilities.Text = Convert.ToString(((100 * bvcbuycount) / 3));
                        // need to check this on 1/june/2016 Label60.Text = "BAND VIEW CALL WITH " + Convert.ToString(((100 * bvcbuycount) / 3)) + "% POSSIBILITIES";
                        //HERE BAP IS A S-BAP IF BAND VIEW CALL BUY OR R-BAP IF BAND VIEW CALL SELL
                        calculatormv.txt_BVCBAP = Convert.ToString(j13); // s-bap
                    ...
                    {
                        calculatormv.txt_tcreversecall = "SELL";
                        // Txt_tcsalesl.Text = Convert.ToString(n6);  // after discussion with sunilbhai as on 4/may/2015
                        calculatormv.Txt_tcsalesl = Convert.ToString(o12);
                        calculatormv.Txt_tcsalet1 = Convert.ToString(j6);
                        calculatormv.Txt_tcsalet2 = Convert.ToString(i6);
                        calculatormv.Txt_tcsalet3 = Convert.ToString(h6);
                        // need to check this on 1/june/2016 Label60.Text = "BAND VIEW CALL WITH " + Convert.ToString(((100 * bvcsellcount) / 3)) + "% POSSIBILITIES";
                        //txt_tcpossibilities.Text = Convert.ToString(((100 * bvcsellcount) / 3));
                        //HERE BAP IS A S-BAP IF BAND VIEW CALL BUY OR R-BAP IF BAND VIEW CALL SELL
                        calculatormv.txt_BVCBAP = Convert.ToString(n13);  // r-bap
